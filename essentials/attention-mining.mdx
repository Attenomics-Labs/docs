...
In Web2, social media platforms profit from your attention span.  
In Web3, you profit from your own attention.

---

## What is Attention Mining?

**Attention Mining** is how users and creators generate on-chain value by posting and engaging with social content.
...
- **Users** mine unique shares of attention from creators by engaging with their content (likes, replies, reposts, quotes).
...
We use:
- A custom scoring model powered by a LLM (via **ORA RMS API**)
